<template>
  <div class="admin-report">
    ...
    <el-table :data="paginatedData" style="width: 100%">
      ...
      <el-table-column prop="title" label="举报帖子标题" width="180"></el-table-column>
      <el-table-column prop="username" label="举报者" width="120"></el-table-column>
      <el-table-column prop="reason" label="举报理由" width="240">
  ...
  methods: {
    ...
    async fetchReports() {
      try {
        ...
        this.reports = response.data.report_posts;  // 假设接口返回的是举报列表
